...
function loadLoaiSanPham() {
	jQuery.ajax({
		...
		url: "http://localhost:8080/spring-security-demo-basic-security/quan-ly/quan-ly-san-pham-load-lsp",
		dataType: 'json',
		timeout: 100000,
...
function loadTongSoLuong(maSanPham) {
	jQuery.ajax({
		type: "GET",
		contentType: 'application/json',
		url: "http://localhost:8080/spring-security-demo-basic-security/quan-ly/quan-ly-san-pham-load-so-luong",
		data: {
			maSanPham,
		},
		dataType: 'json',
...
function getDanhSachSanPhamTheoTen(tenSanPham, trangThai, giaTien, loaiSanPham) {
	jQuery.ajax({
		type: "GET",
		contentType: 'application/json',
		url: "http://localhost:8080/spring-security-demo-basic-security/quan-ly/quan-ly-san-pham-loc",
		data: {
			tenSanPham,
			trangThai,
			giaTien,
		...
		success: function(data) {
			...
			async function pageSanPham() {
				...
				const content = data.map(async (v, index) => {
					trangThai = v.trangThai == "Đang kinh doanh" ? "<td><span class='badge bg-success'>" + v.trangThai + "</span></td>" : "<td><span class='badge bg-warning'>" + v.trangThai + "</span></td>";
...
function deleteSanPham(maSanPham) {
	jQuery.ajax({
		type: "GET",
		contentType: 'application/json',
		url: "http://localhost:8080/spring-security-demo-basic-security/quan-ly/quan-ly-san-pham-doi-trang-thai",
		data: {
			maSanPham,
		},
		dataType: 'json',
...
function capNhatSanPham(maSanPham, tenSanPham, trangThai, giaTien) {
	jQuery.ajax({
		type: "GET",
		contentType: 'application/json',
		url: "http://localhost:8080/spring-security-demo-basic-security/quan-ly/quan-ly-san-pham-cap-nhat",
		data: {
			maSanPham,
			tenSanPham,
			trangThai,
