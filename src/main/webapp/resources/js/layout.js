function quantityPluss() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8080/spring-security-demo-basic-security/san-pham/so-luong-ton/tang",
        data: {
            quantityCurrent,
            quantityTotal,
        },
...
function quantityPrivate() {
    ...
    $.ajax({
        type: "GET",
        contentType: "application/json",
        url: "http://localhost:8080/spring-security-demo-basic-security/san-pham/so-luong-ton/giam",
        data: {
            quantityCurrent,
            quantityTotal,
        },
