                ...
                <div class="display__item row">
                    <div class="pl-5 display__item__filter col-3">
                                ...
                                <div class="">
                                    ...
                                    <div class="card-body">
                                        <form id="price-range-form">
                                            ...
                                            <input type="range" class="form-range " min="1" max="100" id="max-price"
                                                step="1" value="1">
                                        </form>
                                    </div>
                                </div>
                        ...
                        <ul class="categories__nav__level1">
                            <li class="categories__nav__item__level1" id="football">Loại sản phẩm <i
                                    class="fa fa-angle-down" aria-hidden="true"></i></li>
                            <ul class="categories__nav__level2" id="football_items">
                                <li class="categories__nav__item__level2"> <input type="checkbox" name=""> <label
                                        for=""> Thiết bị
                                    </label> </li>
                                <li class="categories__nav__item__level2"> <input type="checkbox" name=""> <label
                                        for=""> Dụng cụ
                            ...
                            <li class="categories__nav__item__level1" id="volleyball">Môn thể thao <i
                                    class="fa fa-angle-down" aria-hidden="true"></i></li>
                            ...
                            <li class="categories__nav__item__level1" id="sportType">Thương hiệu<i
                                    class="fa fa-angle-down" aria-hidden="true"></i></li>
                        ...
                        <ul class="products_featured_nav">
                            <li class="products_featured_item">
                                <div class="products_featured_item_img">
                                    <img src="https://blueskytechco.com/rubix/wp-content/uploads/2022/02/12_Cornstalk-Dracaena_1-600x720.jpg"
                                        alt="">
                                </div>
                    ...
                    <div class="display__item__itemList__item_result">
                        <div class="row">
                            ...
                            <%-- <c:forEach var="item" items="${listSanPham }">
                                <div class="col-3"
                                    onclick="window.location.href='san-pham/chi-tiet-san-pham?maSanPham=${item.maSanPham}'">
                                    <div class="card_item">
                                        <div class="item_img">
                                        ...
                                        <div class="item_info">
                                            ...
                                            <div class="item_info_price">
                                                ...
                                                <div class="item_price">${item.giaTien-item.giaTien*item.chietKhau/100 }
                                                </div>
