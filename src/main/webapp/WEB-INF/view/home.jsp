				...
				<div class="col text-center">
					<div class="new_arrivals_sorting">
						<ul class="arrivals_grid_sorting clearfix button-group filters-button-group">
							...
							<li class="grid_sorting_button button d-flex flex-column justify-content-center align-items-center" data-filter=".women">Quần áo</li>
							<li class="grid_sorting_button button d-flex flex-column justify-content-center align-items-center" data-filter=".accessories">Dụng cụ & thiết bị</li>
							<li class="grid_sorting_button button d-flex flex-column justify-content-center align-items-center" data-filter=".men">Giầy thể thao</li>
						</ul>
					</div>
				</div>
			</div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="deal_ofthe_week_img">
                                <img src="https://sre.com.vn/wp-content/uploads/2020/12/top-5-tay-vot-xuat-sac-nhat-moi-thoi-dai-trong-lang-quan-vot-rafael-nadal-earns-fourth-stefan-edberg-sportsmanship-award.jpg" alt="">
                            </div>
                        </div>
