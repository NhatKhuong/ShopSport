<div class=" ${col !=false ? 'col-sm-6 col-lg-3 ':''} product-item men item"
		...
		<div class="product discount product_filter">
			...
			<div class="product_info">
				...
				<div class="product_price">
					<div class="price"> ${item["giaTien"]-item["giaTien"]*item["chietKhau"]/100 }</div> <span
						class="price">${item["giaTien"] }</span>
				</div>
			</div>
		</div>
