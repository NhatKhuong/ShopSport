							...
							<ul class="top_nav_menu">
								...
								<li class="account">
									...
									<ul class="account_selection">
										...
										<li><a href="" data-toggle="modal" data-target="#RegisterModal" aria-hidden="true"><i class="fa fa-user-plus" aria-hidden="true"></i>Register</a></li>
									</ul>
								</li>
							</ul>
						</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-right">
                        ...
                        <!-- Modal card -->
                        <div class="modal fade model_card" id="CardModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
