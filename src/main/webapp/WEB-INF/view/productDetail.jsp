        ...
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            ...
            <body>
                <div class="container--fluid " s>
                                ...
                                <div class="pt-4">
                                    ...
                                    <div class="option pb-3 mt-4">
                                        <div class="btn-option" id="buy-now">
                                            <button class="btn "> <i class="fa fa-shopping-cart" aria-hidden="true"></i>
                                                Mua
                                                ngay</button>
                                        </div>
                    ...
                    <div class="components container pt-0">
                        <div class="tab p-4">
                                    ...
                                    <form class="create-comment pt-3 text-center">
                                        <div class=" bg-light p-4">
                                            ...
                                            <div class="your-rating">
                                                ...
                                                <div class="ratings">
                                                    <i class="fa fa-star rating-start" id="rating-1" aria-hidden="true">
                                                    </i>
                                                    <i class="fa fa-star rating-start" id="rating-2" aria-hidden="true">
                                                    </i>
