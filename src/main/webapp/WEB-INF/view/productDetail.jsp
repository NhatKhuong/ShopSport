								...
								<div class="product-detail row">
									...
									<form:form modelAttribute="donHang" id="submit-buy-now"
										...
										<div class="ratings pb-4">
											<u class="number-start">4.9</u> <span class="mr-2"> <i class="fa fa-star"
											...
											<div class="option">
												...
												<div class="sizes">
													<c:forEach var="item" items="${dsKichThuoc}">
														...
														<button class="btn mr-2 size btn_kichThuoc" type="button"
											...
											<div class="option pb-3 mt-4">
												...
												<div class="btn-option" id="add-to-cart">
													<button onclick="addToCard()" type="button" class="btn">
														<i class="fa fa-money" aria-hidden="true"></i> Thêm vào giỏ
													</button>
												</div>
											</div>
										</div>
										...
										<form:hidden id="hidden-tenKichThuoc"
											...
											readonly="true" />
										<form:hidden id="hidden-soLuong" path="danhSachChiTietDonHang[0].soLuongMua"
											readonly="true" />
										<!--  /form hiden submit to controller -->
									</form:form>
								</div>
