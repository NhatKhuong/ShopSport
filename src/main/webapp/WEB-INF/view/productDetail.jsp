            ...
            <div class="product-detail row">
                <div class="images-detail col-lg-6 pr-3">
                    <div class="img-main">
                        <div class="img-contain">
                                  ...
                                  <img src="<c:url value='/resources/images/${sanPham.danhSachHinhAnhSanPham[0].hinhAnh}' />"  alt="">
                        </div>
                ...
                <div class="info-detail  pr-6 col-lg-6 ">
                    ...
                    <div class="price-line pb-3">
                        <span class="price-current">${sanPham.giaTien-item.giaTien*sanPham.chietKhau/100 }</span>
                        <bdi class="price-old">${sanPham.giaTien}</bdi>
                    </div>
