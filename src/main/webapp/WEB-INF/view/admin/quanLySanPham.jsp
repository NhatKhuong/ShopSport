<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8" %>
				...
				<main class="app-content">
					...
					<div class="tab-pane active">
						<div class="row">
							<div class="col-md-4">
								<p>
									Tên sản phẩm:<input type="text" id="locTenSanPham" class="form-control">
								</p>

							</div>
							<div class="col-md-4">
								<p>
									Tình trạng: <select class="dashboard-filter form-control" id="mySelect">
							...
							<div class="col-md-4">
								<p>
									Giá tiền:<input type="text" class="form-control" id="giaTien" value="0">
								</p>
							</div>
							<div class="col-md-4">
								<p>
									Loại sản phẩm: <select class="dashboard-filter form-control" id="selectLoaiSanPham">
										...
										<div class="tile-body">
											<div class="row element-button">
												<div class="col-sm-2">
													...
													<a class="btn btn-add btn-sm" href="them-san-pham" title="Thêm"><i
											...
											<table class="table table-hover table-bordered" id="tableListSanPham">
												<thead>
													<tr>
  ...
  MODAL
-->
				<div class="modal fade updateSanPham" id="ModalUP" tabindex="-1" role="dialog" aria-hidden="true"
					data-backdrop="static" data-keyboard="false">
					<div class="modal-dialog modal-dialog-centered  modal-xl" role="document">
						<div class="modal-content">
							<div class="modal-header" style="position: relative;">
								<h5 class="modal-title text-dark" id="exampleModalLabel">Chỉnh sửa thông tin sản phẩm
								</h5>
								<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="position: absolute;     position: absolute;
									top: 0;
									right: 20px;">
								...
								class="form-control" type="number" required value="20">
											...
											<div class="form-group col-md-6">
												<label class="control-label">Giá bán</label> <input class="form-control"
													id="modalGiaSP" type="text" value="5.600.000">
											</div>
									...
									<div class="tab-pane fade" id="pills-contact" role="tabpanel"
										aria-labelledby="pills-contact-tab">Cập nhật sau</div>
								</div>
