  ...
  <main class="app-content">
    ...
    <div class="text-center" style="font-size: 13px">
      <p><b>Copyright
          ...
          </script> Phần mềm quản lý bán thiết bị dụng cụ thể thao | Dev By ADMIN
        </b></p>
    </div>
  </main>
     <script src="${pageContext.request.contextPath}/resources/js/admin/jquery-3.2.1.min.js"></script>
