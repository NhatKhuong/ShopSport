                           ...
                           <%--  <div class="breadcrumb-components">
                            ...
                            <div class="component" style="display: flex; justify-content: space-around;">
                                ...
                                <div class="box  col-8">
                                        ...
                                        <form:form modelAttribute="nguoiDung" action='${pageContext.request.contextPath}/nguoi-dung/update' method="GET">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <form:select path="diaChi.tinhThanhPho" class="form-control"
                                                            id="tinhThanhPho">
                                                            <option selected>${nguoiDung.diaChi.tinhThanhPho}</option>
                                                        </form:select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <form:select path="diaChi.quanHuyen" class="form-control"
                                                            id="quanHuyen">
                                                            <option selected>${nguoiDung.diaChi.quanHuyen}</option>
                                                        </form:select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <form:select path="diaChi.phuongXa" class="form-control"
                                                            id="phuongXa">
                                                            <option selected disabled>${nguoiDung.diaChi.phuongXa}</option>
                                                        </form:select>
                                                        <small class="text-danger d-none " id='helpQuanHuyen'>Bạn chưa
                                                            chọn quận
                                                            huyện</small>
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <form:input path="diaChiChiTiet" type="text" name="diaChiChiTiet"
